...
def estimate_gain(with_sfx, without_sfx, touched=(), sr=SR, floor=0.05):
    ...
    **شرط الاستعمال: التشغيلتان بنفس شكل القنوات.** لو المرجع مونو
    والمزيج ستيريو، المسبار (اللي بيخفض لمونو) بيخترع معامل ١/√٢
    مش موجود بالرسم. صار معنا وسجّلناه كـ"كسب ٠.٤٩٥" قبل ما ننتبه —
    وطلع خلل قياس. مع `-ac 2` على الاتنين النتيجة ٠.٧٠٠٠ بالضبط،
    لمصدر مونو ولستيريو سوا.
